      ...
      <VTabsWindow v-model="tab">
        <VTabsWindowItem value="toast">
          <VRow align="center" justify="center">
            ...
            <VCol cols="4">
              <VCard title="Props">
                <VTextField :model-value="toastOptions.title" label="Title"
                ...
                <VTextField :model-value="toastOptions.icon" label="Icon"
                  @change="toastOptions.icon = $event.target.value" />
                <VSelect v-model="toastOptions.color" clearable
                  :items="['primary', 'secondary', 'success', 'error', 'purple']" label="Color" />
                <VSelect v-model="toastOptions.type" clearable :items="['success', 'info', 'warning', 'error']"
                  label="Type" />
              </VCard>
              <VCard title="Options">
                ...
                <VSlider v-model.number="toastOptions.options.timeout" label="Timeout" min="3000" max="30000"
                  step="1000" thumb-label="always" class="mt-5">
                  <template #thumb-label="{ modelValue }">
                    {{ modelValue / 1000 }}s
                  </template>
                </VSlider>
                <VCardActions>
                  <VBtn block :color="toastOptions.color" text="Show Toast" variant="outlined" @click="onOpenToast" />
                </VCardActions>
              </VCard>
            </VCol>
          </VRow>
